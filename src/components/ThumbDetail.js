...
function ThumbDetail({ image_url, title, population, region, capital ,subregion,borders,languages}) {
    return (
        <div className="container rounded-lg shadow-lg bg-white dark:bg-gray-700 dark:text-white pb-4">
            ...
            <div className="p-4">
                ...
                <p className="text-xs">Sub Region: <span className="text-gray-700 dark:text-gray-300">{subregion}</span></p>
                {/* <p className="text-xs">Capital: <span className="text-gray-700 dark:text-gray-300">{capital}</span></p> */}
                <p className="text-xs">Border: <span className="text-gray-700 dark:text-gray-300">{borders+" "}</span></p>
                {/* <p className="text-xs">Languages: <span className="text-gray-700 dark:text-gray-300">{languages}</span></p> */}
